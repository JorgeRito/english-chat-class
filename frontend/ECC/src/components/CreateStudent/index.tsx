import "C:\\Users\\061571\\OneDrive - Avnet\\Documents\\GitHub\\english-chat-class\\frontend\\ECC\\src\\components\\CreateStudent\\form.css"
...
export function CreateUserForm() {
    ...
    const handleSubmit = async(e: React.FormEvent) => {
        ...
        setUpdate(!update);
        const userInput = document.getElementById('nombre_completo') as HTMLInputElement;
    ...
    return(
        <div>
            ...
            <StudentsTable updateButton={update} onDelete={handleDelete} onSave={handleSave}/>
        </div>
    )
}